...
- `jamie_ref.wav` - Voice reference audio (59KB)
...
1. **Get Real Voice Samples:** Provide authentic WAV reference files for Ava, Zoe, Serena, Isha, Oliver in voices/ directory for better ChatterboxTTS voice cloning
