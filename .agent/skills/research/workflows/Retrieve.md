...
→ **Escalate to Layer 2 (bright-data)**
...
| Feature | Layer 1 (Built-in) | Layer 2 (bright-data) | Layer 3 (Apify) |
|---------|-------------------|----------------------|-----------------|
...
- Layer 2: bright-data scrape_as_markdown (success/failed)
