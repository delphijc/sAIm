    ...
    <div class="lane-header">
      <div class="header-left">
        ...
        <div
          ...
          :title="`Total events in last ${timeRange === '1M' ? '1m' : timeRange === '2M' ? '2m' : '5m'}`"
        >
        ...
        <div
          ...
          :title="`Tool calls in last ${timeRange === '1M' ? '1m' : timeRange === '2M' ? '2m' : '5m'}`"
        >
        ...
        <div
          ...
          :title="`Avg gap in last ${timeRange === '1M' ? '1m' : timeRange === '2M' ? '2m' : '5m'}`"
        >
