  ...
  <div class="modern-dashboard">
    ...
    <div class="agent-bar px-5 py-2 mobile:px-3 mobile:py-1.5 border-b border-white/[0.03] bg-[var(--theme-bg-primary)]">
      ...
      <div class="flex gap-2 min-h-[32px] mt-2 pt-2 border-t border-white/[0.03]">
        ...
        <!-- Grayed out placeholder agents when none active: User and Sam -->
        <template v-if="stableAgentNames.length === 0">
          <div
            v-for="placeholderAgent in ['User', 'Sam']"
...
import {
  Loader2, Cpu, Sparkles, Terminal, DollarSign, Moon, Wrench,
  // Tool icons
  FileText, FileEdit, FilePlus, Search, FolderSearch, Globe, Send, Code, MessageSquare, Cog, Play, type LucideIcon,
  // Skill/Workflow icons
  Settings2, Hammer
} from 'lucide-vue-next';

import ContextWidget from './widgets/ContextWidget.vue';
...
// Sam context (learnings, active skill, session duration)
