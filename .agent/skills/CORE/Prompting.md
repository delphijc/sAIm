...
description: Prompt engineering standards and context engineering principles based on Anthropic best practices and the Fabric system (2024). Universal principles for semantic clarity and structure that transcend specific model implementations. Validated by empirical research showing 10-90% performance impact from structure choices.
---

# Prompt Engineering Standards

**Foundation:** Based on Anthropic's context engineering principles and the Fabric system (January 2024), validated by empirical research across 1,500+ academic papers and production systems.
...
This document defines the standards for creating effective prompts and context documentation for AI agents within the Sam system, based on Anthropic's context engineering principles.
...
**Originally created by Daniel Miessler** as an open-source framework for augmenting humans using AI.
