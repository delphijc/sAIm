...
✓ CORRECT: create-skill (or create-skill for multi-word)
```
...
### Naming (TitleCase)
- [ ] Skill directory uses TitleCase (e.g., `Blogging`, `create-skill`)
...
| Multi-word skill | `create_skill`, `CREATE_SKILL` | `create-skill` |
